...
type Task struct {
	...
	FileData      string                 `protobuf:"bytes,5,opt,name=file_data,json=fileData,proto3" json:"file_data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Task) GetFileData() string {
	if x != nil {
		return x.FileData
	}
	return ""
...
const file_internal_proto_service_proto_rawDesc = "" +
	...
	"\tfile_data\x18\x05 \x01(\tR\bfileData\"\xc2\x01\n" +
	"\n" +
	"TaskResult\x12\x17\n" +
